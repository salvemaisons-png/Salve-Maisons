...
import { packages, waLink } from "@/data/services";
import detailImg from "@/assets/spa-detail.jpg";

const PackagesPage = () => (
  <Layout
      title="Spa Packages & Gift Vouchers | Salve Maison"
      description="Half-day and full-day spa packages plus gift vouchers at Salve Maison, Lekki, Lagos. Reserve your escape today."
    >
    <section className="bg-gradient-soft py-20 md:py-24">
      <div className="max-w-7xl mx-auto px-4 md:px-8 text-center">
        ...
        <p className="mt-5 text-muted-foreground max-w-2xl mx-auto">
          Curated combinations of our most-loved treatments, with time built in to breathe between
          them. Perfect for birthdays, brides and long-overdue self-care.
        </p>
      </div>
    </section>
    ...
    <section className="pb-24">
      <div className="max-w-5xl mx-auto px-4 md:px-8 grid md:grid-cols-2 gap-10 items-center  bg-cream p-8 md:p-12">
        <img
          src={detailImg}
          alt="Spa towels, candles and rose petals"
          width={1200}
          height={900}
          loading="lazy"
