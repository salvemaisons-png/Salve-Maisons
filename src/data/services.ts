...
export const packages: Package[] = [
  { id: "essential-escape", collection: "Signature Rituals", name: "The Essential Escape", price: "₦85,000", duration: "Duration on request", includes: ["Deep Tissue Massage", "Body steaming"] },
  { id: "relaxation-ritual", collection: "Signature Rituals", name: "The Relaxation Ritual", price: "₦75,000", duration: "Duration on request", includes: ["Aromatherapy Massage", "Indian Head Massage"] },
  { id: "glow-ritual", collection: "Signature Rituals", name: "The Glow Ritual", price: "₦140,000", duration: "Duration on request", description: "A lovely self-care package.", includes: ["Glow Facial", "Silk Polish body scrub"] },
  { id: "executive-reset", collection: "Signature Rituals", name: "The Executive Reset", price: "₦70,000", duration: "Duration on request", includes: ["Back, Neck & Shoulder Massage", "Indian Head Massage", "Reflexology"] },
  { id: "signature-retreat", collection: "Signature Rituals", name: "The Signature Retreat", price: "₦150,000", duration: "Duration on request", includes: ["Swedish Massage", "Glow Facial", "Signature Pedicure"] },
  { id: "ultimate-maison", collection: "Signature Rituals", name: "The Ultimate Maison", price: "₦170,000", duration: "Duration on request", includes: ["Massage of choice", "Facial of choice", "Signature Manicure or Signature Pedicure"] },
